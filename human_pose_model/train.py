...
if __name__ == '__main__':
    ...
    dataset = GolfDB(data_file='/content/drive/MyDrive/Github/joeklein-gaalevy-wemarti-fp/data/train_split_{}.pkl'.format(split),
    ...
    while i < iterations:
        for sample in data_loader:
            images, landmarks, labels = sample['images'].cuda(), sample['landmarks'].cuda(), sample['labels'].cuda()
